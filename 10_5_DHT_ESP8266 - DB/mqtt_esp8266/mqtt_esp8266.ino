//참조유튜브 http://i2r.link
// 1-16-2-2 mqtt, json : https://youtu.be/stmFLWuzmqE
// 3.0.27 DHT11 온습도센서 : https://youtu.be/NvOYnW88cN0
...
void tick()
{
  ...
  */
  snprintf (msg, 75, "{\"chip\":\"%s\", \"hu\":%.1f, \"te\":%.1f}",cChipID, humidity, temperature);
  client.publish(outTopic, msg);
  Serial.println(msg);
}
